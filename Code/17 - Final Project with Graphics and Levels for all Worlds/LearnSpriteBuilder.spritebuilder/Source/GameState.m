...
-(int) levelCount
{
	...
	do
	{
		...
		// published CCB files go by the extension "ccbi" and are located in "Published-xxx" folder (case sensitive!)
#if __CC_PLATFORM_IOS
		NSString* dir = @"Published-iOS/Levels";
#elif __CC_PLATFORM_ANDROID
		NSString* dir = @"Published-Android/Levels";
#endif

		NSString* level = [NSString stringWithFormat:@"Level%i", count];
		path = [mainBundle pathForResource:level ofType:@"ccbi" inDirectory:dir];
